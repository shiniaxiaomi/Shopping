...
<form method="post" name="form" action="admin/UserModify.jsp">
	...
	<table class="tableborder" align="center" cellpadding="4"
		...
		<tbody>
			...
			<tr>
				...
				<td class="altbg2">
					<input id="userid" name="username" size="25" maxlength="25" type="text" value="<%=user.getUsername()%>"> <span id="usermsg"></span>
			</tr>

			<tr>
				<td class="altbg1">&#30005;&#35805;:</td>
				<td class="altbg2"><input name="phone" type="text" id="phone" value="<%=user.getPhone()%>"
					size="25"></td>
			</tr>
			...
			<tr>
				...
				<td class="altbg2">
					<textarea name="addr" cols="60" rows="5" id="addr"><%=user.getAddr()%></textarea>
				</td>
			</tr>
		</tbody>
	</table>
	<br>
	<center>
		<input name="regsubmit" value="修 &nbsp; 改" type="submit">
	</center>
</form>
